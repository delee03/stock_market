...
@dag(
    ...
    tags=['stock_market'],
     on_success_callback=[
        send_slack_notification(
            slack_conn_id='slack',
            text=(
                ":white_check_mark: *DAG `stock_market` completed successfully!* \n"
                "Check the details in Airflow UI for more info."
            ),
            channel="#general",
            username="AirflowBot"
        )
    ...
    on_failure_callback=[
        send_slack_notification(
            slack_conn_id='slack',
            text=(
                ":red_circle: *DAG `stock_market` failed!* \n"
                "Please check the logs in Airflow UI for troubleshooting."
            ),
            channel="#general",
            username="AirflowBot"
        )
